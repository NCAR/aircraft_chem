function     [rtnMsg] = createUser2401file(StartPath,picPath2401user,slash,fltno,fltnoLC,...
    ...
    fileCountUser2401 = length(fileListUser2401);
        ...
        UsrCo_raw2401=dTotal2401User(:,19);
        UsrCo2_raw2401=dTotal2401User(:,20);
        UsrCo2_dry2401=dTotal2401User(:,21);
        UsrCh4_raw2401=dTotal2401User(:,22);
        UsrCh4_dry2401=dTotal2401User(:,23);
        UsrH2o=dTotal2401User(:,24);
        UsrH2oReported=dTotal2401User(:,25);
        Usr_b_H2o_pct=dTotal2401User(:,26);
        UsrMPVposition=dTotal2401User(:,14);
        UsrInletValves=dTotal2401User(:,15);
        UsrOutletValves=dTotal2401User(:,16);
...
%             'UsrSpecies','dTotal2401User');
        ...
        save([picPath2401user slash char(fltnoLC) slash FltDate '_' char(fltno) '_rawPic2401User.mat']);
